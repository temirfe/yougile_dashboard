...
def fetch_yougile_projects(request):
    if 'company' in request.GET:
        ...
        context = fetch_and_save_projects(company)
    else:
...
def fetch_yougile_boards(request):
    ...
    if 'company' in request.GET:
        company = request.GET['company']
        context = fetch_and_save_boards(company)
    else:
...
def fetch_yougile_columns(request):
    ...
    if 'company' in request.GET:
        company = request.GET['company']
        context = fetch_and_save_columns(company)
    else:
...
def fetch_yougile_users(request):
    if 'company' in request.GET:
        company = request.GET['company']
        context = fetch_and_save_users(company)
    else:
