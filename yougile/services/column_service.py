...
def fetch_columns(company, board_id=None, offset=0, limit=1000):
    """
    ...
    try:
        ...
        data = api_client.get("/columns", params=params)
        return data
...
def save_columns(columns):
    ...
    unique_board_api_ids = set(bd.get('boardId') for bd in columns if 'boardId' in bd)
